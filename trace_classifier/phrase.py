...
def create_phrases(df, word_vec_col, sentence_id_col, word_pos_col,
                   phrase_pos_col='phrase_pos', phrase_col='phrase',
                   word_count_col='word_count', desired_phrase_length=15):
    """
